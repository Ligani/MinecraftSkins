...
При самом первом запуске апишка может стартовать быстрее, чем база данных успеет полностью инициализироваться. В таком случае миграции не применятся автоматически. Подождите 10–15 секунд, чтобы база данных была готова, и выполните команду для перезапуска:
